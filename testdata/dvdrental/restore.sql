...
\copy public.actor (actor_id, first_name, last_name, last_update) FROM 'testdata/dvdrental/3057.dat';
...
\copy public.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM 'testdata/dvdrental/3065.dat';
...
\copy public.category (category_id, name, last_update) FROM 'testdata/dvdrental/3059.dat';
...
\copy public.city (city_id, city, country_id, last_update) FROM 'testdata/dvdrental/3067.dat';
...
\copy public.country (country_id, country, last_update) FROM 'testdata/dvdrental/3069.dat';
...
\copy public.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM 'testdata/dvdrental/3055.dat';  
...
\copy public.film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM 'testdata/dvdrental/3061.dat';  
...
\copy public.film_actor (actor_id, film_id, last_update) FROM 'testdata/dvdrental/3062.dat';
...
\copy public.film_category (film_id, category_id, last_update) FROM 'testdata/dvdrental/3063.dat';
...
\copy public.inventory (inventory_id, film_id, store_id, last_update) FROM 'testdata/dvdrental/3071.dat';
...
\copy public.language (language_id, name, last_update) FROM 'testdata/dvdrental/3073.dat';
...
\copy public.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM 'testdata/dvdrental/3075.dat';
...
\copy public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM 'testdata/dvdrental/3077.dat';
...
\copy public.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM 'testdata/dvdrental/3079.dat';
...
\copy public.store (store_id, manager_staff_id, address_id, last_update) FROM 'testdata/dvdrental/3081.dat';
